package exhibitmanagementsystemandroid.cput.ac.za.exhibitmanagementsystemandroid.repository.Docs;
 ...
 */
public interface PreciousMetalsRepository extends Repository <PreciousMetals, Long> {
}
